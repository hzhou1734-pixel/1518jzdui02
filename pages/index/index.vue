	...
	export default {
		...
		data() {
			...
			defaultSeckillConfig: {
				...
				fillet: { val: 16, type: 0 },
				styleConfig: { tabVal: 0 },
				titleConfig: { tabVal: 0 },
				titleTxtConfig: { value: '限时秒杀' },
				imgConfig: { url: '' },
				imgColorConfig: { url: '' },
				tipsColor: { color: [{ item: 'rgba(255,255,255,0.8)' }] },
				tipsColor2: { color: [{ item: 'rgba(255,255,255,0.8)' }] },
				rightBntConfig: { value: '更多' },
				headerBntColor: { color: [{ item: 'rgba(255,255,255,0.8)' }] },
				headerBntColor2: { color: [{ item: 'rgba(255,255,255,0.8)' }] },
				bntNumber: { val: 12 },
				headerBgColor: { color: [{ item: '#C10000' }, { item: '#E93323' }] },
				goodStyleConfig: { tabVal: 3 },
				seckillConfig: { tabVal: 0 },
				filletImg: { val: 12, type: 0 },
				...
				goodsBntColor: { color: [{ item: '#C10000' }, { item: '#E93323' }] },
